...
[](#11-why-to-evaluate-architecture)1.1. Why to evaluate architecture?
----------------------------------------------------------------------
...
[](#12-什么时候需要评估架构呢when-to-evaluate-an-architecture)1.2. 什么时候需要评估架构呢？When to evaluate an architecture?
-----------------------------------------------------------------------------------------------------
...
[](#13-why-evaluate-architecture-early)1.3. Why evaluate architecture early?
----------------------------------------------------------------------------
...
2.  早期质量评估具有成本效益（AT&T：生产力提高 10%/1991 年项目） - 最近，通过及早发现和解决问题，在 100,000 行 (不含注释) 的系统上节省了 100 万美元 Early quality evaluation is cost effective (AT&T: 10% productivity increase/project 1991) - Lately, $I million savings on systems of 100,000 non-commentary LOC by detecting and resolving problems early
...
[](#14-如何评估软件架构-how-to-evaluate-software-architecture)1.4. 如何评估软件架构 How to evaluate software architecture?
----------------------------------------------------------------------------------------------------------
...
[](#15-方法如何可以变得有用how-can-a-method-be-helpful)1.5. 方法如何可以变得有用？How can a method be helpful!?
------------------------------------------------------------------------------------------

1.  帮助涉众尽早问正确的问题来：It helps stakeholders ask right questions early to:
    1.  识别风险：可能对所需质量属性产生负面影响的架构决策 Identify risks: Architectural decisions that may negatively affect desired quality attributes
    2.  发现敏感点：特定质量属性对其敏感的架构决策 Find sensitivity points: Architecture decisions to which a particular quality attribute is sensitive to
...
[](#16-评价分析方法-analysis-methods-for-evaluation)1.6. 评价分析方法 Analysis Methods for Evaluation
-----------------------------------------------------------------------------------------

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec18/2.png)

[](#17-评估格式-evaluate-forms)1.7. 评估格式 Evaluate Forms
---------------------------------------------------
...
[](#21-阶段-phase)2.1. 阶段 Phase
-----------------------------

1.  ATAM 方法分为 4 个阶段完成

### [](#211-阶段0准备好伙伴-phase-0-partnership-8-preparation)2.1.1. 阶段 0：准备好伙伴 Phase-0: Partnership 8 Preparation
...
### [](#212-阶段1评估1-phase-1-evaluation-1)2.1.2. 阶段 1：评估 (1) Phase-1: Evaluation (1)
...
### [](#213-阶段2评估2-phase-2-evaluation-2)2.1.3. 阶段 2：评估 (2) Phase-2: Evaluation (2)
...
### [](#214-阶段3后续-phase-3-follow-up)2.1.4. 阶段 3：后续 Phase-3: Follow-up
...
### [](#215-atam阶段总结-summary-of-atam-phases)2.1.5. ATAM 阶段总结 Summary of ATAM phases

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec18/3.png)

[](#22-第一阶段的步骤-steps-of-phase-1)2.2. 第一阶段的步骤 Steps of Phase-1
-------------------------------------------------------------

### [](#221-第一步介绍atam-step1-present-the-atam)2.2.1. 第一步：介绍 ATAM Step1 - Present the ATAM
...
### [](#222-第二步介绍业务驱动因素-step2-present-the-business-drivers)2.2.2. 第二步：介绍业务驱动因素 Step2 - Present the Business Drivers
...
### [](#223-第三步介绍架构-step3-present-the-architecture)2.2.3. 第三步：介绍架构 Step3 - Present the architecture
...
### [](#224-第四步确定架构方法-step4-identify-architectural-approaches)2.2.4. 第四步：确定架构方法 Step4 - Identify Architectural Approaches
...
### [](#225-第五步生成质量属性效用树-step5-generate-quality-attribute-utility-tree)2.2.5. 第五步：生成质量属性效用树 Step5 - Generate Quality Attribute Utility Tree
...
### [](#226-第六步分析架构方法-step6-analyze-architectural-approaches)2.2.6. 第六步：分析架构方法 Step6 - Analyze Architectural Approaches
...
### [](#227-atam-第-1-天的示例议程-example-agenda-for-day-1-for-atam)2.2.7. ATAM 第 1 天的示例议程 Example Agenda for Day 1 for ATAM

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec18/6.png)

[](#23-阶段2的步骤-steps-of-phase-2)2.3. 阶段 2 的步骤 Steps of phase-2
-------------------------------------------------------------

### [](#231-第一步展示atam和之前的结果-step-1-present-the-atam-previous-results)2.3.1. 第一步：展示 ATAM 和之前的结果 Step-1: Present the ATAM & Previous Results
...
### [](#232-第七步头脑风暴并确定场景的优先级-step-7-brainstorm-prioritize-scenarios)2.3.2. 第七步：头脑风暴并确定场景的优先级 Step-7: Brainstorm & Prioritize Scenarios
...
### [](#233-第八步分析架构方法-step-8-analyze-architectual-approaches)2.3.3. 第八步：分析架构方法 Step-8: Analyze Architectual Approaches
...
### [](#234-第九步展示结果-step-9-present-results)2.3.4. 第九步：展示结果 Step-9: Present Results
...
[](#24-summary-of-atam-phases)2.4. Summary of ATAM Phases
---------------------------------------------------------

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec18/7.png)

[](#25-atam输出总结-summary-of-atam-outputs)2.5. ATAM 输出总结 Summary of ATAM Outputs
------------------------------------------------------------------------------
...
[](#26-lightweight-architecture-evaluation)2.6. Lightweight Architecture Evaluation
-----------------------------------------------------------------------------------
