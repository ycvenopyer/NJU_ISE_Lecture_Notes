...
[](#11-为什么要记录软件架构-why-to-document-software-architecture)1.1. 为什么要记录软件架构？ Why to document software architecture?
---------------------------------------------------------------------------------------------------------------
...
[](#12-记录架构的挑战-challenges-in-documenting-architecture)1.2. 记录架构的挑战 Challenges in documenting architecture
---------------------------------------------------------------------------------------------------------
...
[](#13-what-to-document)1.3. What to document?
----------------------------------------------
...
[](#14-7-rules-for-architecture-documentation)1.4. (7) Rules for Architecture Documentation
-------------------------------------------------------------------------------------------
...
[](#21-views-视图)2.1. Views 视图
-----------------------------

### [](#211-styles-and-views-样式和视图)2.1.1. Styles and Views 样式和视图

#### [](#2111-three-categories-of-styles)2.1.1.1. Three Categories of Styles
...
#### [](#2112-架构风格-和-架构模式-styles-vs-patterns)2.1.1.2. 架构风格 和 架构模式 Styles Vs. Patterns
...
### [](#212-architectura-views)2.1.2. Architectura Views
...
### [](#213-structural-views-结构关系视图)2.1.3. Structural Views 结构关系视图

#### [](#2131-module-views-模块视图)2.1.3.1. Module Views 模块视图
...
#### [](#2132-component-connector-views)2.1.3.2. Component-Connector Views
...
#### [](#2133-分配视图-allocation-views)2.1.3.3. 分配视图 Allocation Views
...
### [](#214-质量视图-quality-views)2.1.4. 质量视图 Quality Views

1.  安全视图 Security view
2.  性能视图 Performance view
3.  可靠性视图 Reliability view
4.  沟通视图 Communication View
5.  异常 (错误处理) 视图 Exception view (error-handling) view

### [](#215-文档视图-documenting-views)2.1.5. 文档视图 Documenting Views

#### [](#2151-使用3步选择视图-3-step-for-choosing-views)2.1.5.1. 使用 3 步选择视图 3-Step for Choosing Views
...
#### [](#2152-利益相关者和文件-stakeholder-and-documentation)2.1.5.2. 利益相关者和文件 Stakeholder and Documentation

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec17/5.png)

#### [](#2153-利益相关者视图表-stackholder-view-table)2.1.5.3. 利益相关者视图表 Stackholder-View Table

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec17/6.png)

*   上图中每一个格子是指涉众对某一个部分的细节了解程度。

### [](#216-组合视图-combining-views)2.1.6. 组合视图 Combining Views
...
### [](#217-view-template)2.1.7. View Template
...
2.  第 2 部分：**元素目录** Section-2: The **Element Catalog**
...
3.  第 3 部分：**上下文图** Section-3: **Context Diagram**
    1.  系统或其部分如何与其环境相关 how the system or its portion relates to its envlronment
4.  第 4 部分：**可变性** 指南 Section-4: **Variability** Guide
...
### [](#218-上下文图-context-diagram)2.1.8. 上下文图 Context Diagram

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec17/10.png)

[](#22-超越超越观点的信息beyondinformation-beyond-views)2.2. 超越（超越观点的信息）Beyond(Information Beyond Views)
-----------------------------------------------------------------------------------------------

### [](#221-超越视图的文档-documentation-beyond-views)2.2.1. 超越视图的文档 Documentation Beyond Views

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec17/11.png)

### [](#222-文件控制信息-document-control-information)2.2.2. 文件控制信息 Document Control information

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec17/12.png)

1.  第 1 部分：文档路线图说明文档中的信息以及在哪里可以找到它 Section-1: Documentation Roadmap tells what in formation is in the documentation and where to find it
...
### [](#223-mapping-between-views)2.2.3. Mapping between Views

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec17/13.png)

### [](#224-documentation-package)2.2.4. Documentation Package
