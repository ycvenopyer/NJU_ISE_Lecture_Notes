...
[](#15-外观模式实例与解析)1.5. 外观模式实例与解析
-------------------------------

### [](#151-实例一电源总开关)1.5.1. 实例一：电源总开关
...
2.  Session 外观模式是外观模式在 Java EE 框架中的应用。
...
### [](#181-一个系统有多个外观类)1.8.1. 一个系统有多个外观类
...
[](#25-享元模式实例与解析)2.5. 享元模式实例与解析
-------------------------------

### [](#251-实例一共享网络设备无外部状态)2.5.1. 实例一：共享网络设备（无外部状态）
...
### [](#252-实例二共享网络设备有外部状态)2.5.2. 实例二：共享网络设备（有外部状态）
...
### [](#291-单纯享元模式和复合享元模式)2.9.1. 单纯享元模式和复合享元模式
...
### [](#292-享元模式与其他模式的联用)2.9.2. 享元模式与其他模式的联用
...
<table><thead><tr><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec09/15.png"></th><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec09/16.png"></th></tr></thead><tbody></tbody></table>
...
[](#35-代理模式实例与解析)3.5. 代理模式实例与解析
-------------------------------

### [](#351-实例一论坛权限控制代理)3.5.1. 实例一：论坛权限控制代理
...
### [](#352-实例二数学运算代理)3.5.2. 实例二：数学运算代理
