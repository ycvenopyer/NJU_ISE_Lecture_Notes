...
[](#15-桥接模式实例与解析)1.5. 桥接模式实例与解析
-------------------------------

### [](#151-实例一模拟毛笔)1.5.1. 实例一：模拟毛笔
...
[](#16-实例二跨平台视频播放器)1.6. 实例二：跨平台视频播放器
------------------------------------
...
### [](#1101-适配器模式与桥接模式的联用)1.10.1. 适配器模式与桥接模式的联用
...
### [](#1102-适配器模式与桥接模式的联用)1.10.2. 适配器模式与桥接模式的联用
...
[](#24-装饰模式实例与解析)2.4. 装饰模式实例与解析
-------------------------------

### [](#241-实例一变形金刚)2.4.1. 实例一：变形金刚
...
### [](#242-实例二多重加密系统)2.4.2. 实例二：多重加密系统
