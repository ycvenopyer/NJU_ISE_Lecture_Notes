...
[](#15-适配器模式实例与解析)1.5. 适配器模式实例与解析
---------------------------------

### [](#151-实例一仿生机器人)1.5.1. 实例一：仿生机器人
...
1.  在 JDK 类库中也定义了一系列适配器类，如在 com.sun.imageio.plugins.common 包中定义的 **InputStreamAdapter** 类，用于包装 ImageInputStream 接口及其子类对象。
...
[](#25-组合模式实例与解析)2.5. 组合模式实例与解析
-------------------------------

### [](#251-实例一水果盘)2.5.1. 实例一：水果盘
