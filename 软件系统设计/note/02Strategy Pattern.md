...
4.  对应实现的原则：**开闭原则**
5.  识别应用程序中各个方面，将其与保持不变的方面分开
6.  将变化的部分封装起来，以便以后可以更改或扩展变化的部分而不会影响那些不变的部分
...
3.  关键在于，Duck 现在将**委托**其飞行和鸣叫行为，而不是使用 Duck 类 (或子类) 中定义的 quacking 和 flying 方法
4.  委托是调用另一个部分的方法

## 4.整合鸭子行为

### 4.1. (1) 首先，我们将两个实例变量添加到 Duck 类中
...
<table><thead><tr><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec02/12.png"></th><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec02/13.png"></th></tr></thead><tbody><tr><td><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec02/14.png"></td><td><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-Software-System-Design/img/lec02/15.png"></td></tr></tbody></table>
...
1. 合成为您提供了更多的灵活性
2. 它不仅使您可以将一系列算法封装到自己的类中,而且还使您可以在运行时更改行为
...
2.  FLO：给我 C.J. 白色，黑色和白色，杰克 · 本尼 (Jack Benny)，一台收音机，一艘船屋，一份普通咖啡并烧一烧！
