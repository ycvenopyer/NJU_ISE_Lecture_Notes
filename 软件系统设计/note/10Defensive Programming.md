...
[](#11-可用-正确和优秀的代码)1.1. 可用、正确和优秀的代码
-----------------------------------
...
[](#13-你的软件开发过程是怎样的)1.3. 你的软件开发过程是怎样的？
--------------------------------------
...
[](#24-断言assertions)2.4. 断言 Assertions
--------------------------------------
...
### [](#248-不变式invariants)2.4.8. 不变式 Invariants
...
### [](#2410-question-应该进行多少约束校验)2.4.10. Question: 应该进行多少约束校验？
...
### [](#2412-断言-vs-错误处理)2.4.12. 断言 vs. 错误处理
...
### [](#351-trace-a-program-execution)3.5.1. Trace a Program Execution
...
2.  在设计上需要增加 EmployeeDataNotAvailable 异常类型，  
    并将更底层的 EOFException 异常映射为该异常类型 3

### [](#355-使用建议补)3.5.5. 使用建议 (补)
...
[](#41-移除辅助调试代码的方法)4.1. 移除辅助调试代码的方法
-----------------------------------
...
[](#44-移除辅助调试代码的方法补)4.4. 移除辅助调试代码的方法 (补)
----------------------------------------
...
[](#46-产品代码中应该保留多少防御式代码)4.6. 产品代码中应该保留多少防御式代码
---------------------------------------------
