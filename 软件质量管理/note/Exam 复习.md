...
[](#12-四大本质难题之间的关系)1.2. 四大本质难题之间的关系
-----------------------------------
...
1.  【2020-mid】关于 Brooks 提及的软件开发本质难题，下列说法中不准确的是:(AB)
...
[](#23-网络化和服务化)2.3. 网络化和服务化
---------------------------

### [](#231-网络化和服务化)2.3.1. 网络化和服务化
...
### [](#232-更深化的网络化和服务化)2.3.2. 更深化的网络化和服务化
...
### [](#312-软件过程管理)3.1.2. 软件过程管理

1.  软件过程管理的对象是软件过程。
2.  软件过程管理的目的是为了**让软件过程在开发效率、质量等方面有着更好性能绩效**（Performance）

### [](#313-软件过程管理与软件过程改进)3.1.3. 软件过程管理与软件过程改进
...
6.  XP 与 CMM/CMMI 是对立的两种软件开发方法：
    1.  CMM 和 CMMI 并不是软件开发方法，而是软件过程管理和改进，CMM 和 CMMI 是没有较大区别的，错误的。
    2.  XP 的观念确实与严格的 CMM/CMMI 是对立的
    3.  XP 是软件开发方法，敏捷的
7.  CMM/CMMI 不适合当今互联网环境的项目管理需求：CMM/CMMI 是用来做过程管理和改进的，根本不是满足项目管理需求的手段，正确的。
8.  PDCA 和 IDEAL 不适合在敏捷环境中使用：PDCA，IDEAL 是软件过程改进参考元模型，因此是适合在敏捷环境中使用的，错误的。
9.  不同的软件开发过程应该使用不同的生命周期模型，反之亦如此：生命周期模型是由人类划分的，不一定，错误的，

### [](#324-软件过程管理改进模型cmm)3.2.4. 软件过程管理 / 改进模型：CMM

1.  定义：CMM 是一种用于评价软件承包能力并帮助其改善软件质量的方法，侧重于软件开发过程的管理及工程能力的提高与评估。
2.  级别：分为五个级别，一级为初始级，二级为可重复级，三级为已定义级，四级为已管理级，五级为优化级。

### [](#325-等级一初始级-initial)3.2.5. 等级一：初始级 Initial
...
### [](#326-等级二可重复级-repeatable)3.2.6. 等级二：可重复级 Repeatable
...
### [](#327-等级三已定义级-defined)3.2.7. 等级三：已定义级 Defined
...
### [](#328-等级四已管理级-managed)3.2.8. 等级四：已管理级 Managed
...
### [](#329-等级五优化级-optimizing)3.2.9. 等级五：优化级 Optimizing
...
1.  【2015B】CMM 的创始⼈是哪位_____? ©
    1.  Boehm
    2.  Juran
    3.  Humphrey
    4.  Crosby

<table><thead><tr><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/13.png" style="width: auto;"></th><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/14.png"></th></tr></thead><tbody></tbody></table>

[](#33-软件过程管理改进模型cmmi-capability-maturity-model-integration-能力成熟度集成模型)3.3. 软件过程管理 / 改进模型：CMMI Capability Maturity Model Integration 能力成熟度集成模型
---------------------------------------------------------------------------------------------------------------------------------------------
...
4.  更多讨论：[试论 CMM/CMMI 不适合在当前软件开发当中应用的原因](https://www.jianshu.com/p/b7407257eedb)
...
[](#34-软件过程改进模型pdca模型)3.4. 软件过程改进模型：PDCA 模型
-------------------------------------------
...
9.  【2015B】【2016】请描述 PDCA 模型的主要步骤（5 分）

[](#35-软件过程改进模型ideal模型)3.5. 软件过程改进模型：IDEAL 模型
---------------------------------------------

1.  IDEAL 模型解决了软件组织在各种质量改进环境下的需要。它包括了软件过程改进周期中的五个阶段，IDEAL 是代表这五个阶段的单词的⾸字母。
    1.  I: Initiating 初始
    2.  D: Diagnosing 诊断
    3.  E: Establishing 建⽴
    4.  A: Acting 执⾏
...
[](#36-软件过程管理模型isoiec-1504)3.6. 软件过程管理模型：ISO/IEC 1504
-----------------------------------------------------
...
[](#38-软件过程改进模型)3.8. 软件过程改进模型
-----------------------------

1.  重点关注 “过程质量”，强调 “持续改进”
2.  获得 ISO 9000 标准认证的企业应该具有 CMM 第 2~3 级的水平

[](#39-软件质量管理发展软件质量大师的主要观点和贡献-工作)3.9. 软件质量管理发展：软件质量大师的主要观点和贡献、工作
----------------------------------------------------------------

> 描述下述质量管理大师的主要观点和贡献，工作对软件过程和项目管理的借鉴意义

### [](#391-shewhart)3.9.1. Shewhart

1.  最早将**统计控制**的思想引入质量管理，是质量改进奠基人;
2.  提出 PDS 模型 (计划执行检查 Plan-Do-See)，后被戴明进一步发展为 PDCA。

### [](#392-20132015b2016deming)3.9.2. 【2013】【2015B】【2016】Deming

1.  **质量改进**：提出**质量改进**的思想，被称为日本质量管理之父。
2.  **PDCA 循环**：提出 PDCA 循环，被称为 “**戴明环**”(Plan、 Do、Check、 Action)，为最基本的质量和管理工具
3.  **14 条原则**：
...
### [](#393-20132015b2016juran)3.9.3. 【2013】【2015B】【2016】Juran
...
4.  提出 **Juran 质量螺旋**;
5.  提出 **80/20 原则**，认为有 80% 的质量问题是由于领导责任引起的。从而将人力与质量管理结合起来。

### [](#394-20132015b2016crosby)3.9.4. 【2013】【2015B】【2016】Crosby
...
### [](#395-2015b2016humphrey-软件过程之父)3.9.5. 【2015B】【2016】Humphrey 软件过程之父

1.  采用 Crosby 的成熟度度量，提出了软件能力成熟度模型 (CMM) ，对于软件过程管理与改进具有建设性作用。
2.  将上述的理论和实践引入软件过程。

# 4.软件开发实践

[](#41-敏捷软件开发)4.1. 敏捷软件开发
-------------------------
...
#### [](#4132-考试题)4.1.3.2. 考试题

1.  【2020-mid】请完整描述敏捷宣言

### [](#414-敏捷软件开发方法)4.1.4. 敏捷软件开发方法

#### [](#4141-极限编程-xp)4.1.4.1. 极限编程 XP
...
4.  Scrum 常见活动
    ...
    5.  sprint
5.  Empirical Process Control VS. Statistical Process Control，不同于统计过程控制方法（也叫预测式、计划式）不能解决不可预见的需求变化问题，Scrum 采用的实证过程控制承认问题无法完全理解或定义，即用户可以在项目过程中变更需求，关注于如何使开发团队**快速推出和响应需求变化的能力**最大化
6.  Scrum VS. XP
    1.  **迭代周期**不同。XP 迭代周期为 12 周，而 Scrum 迭代周期为 24 周
    2.  迭代中是否允许**需求变更**。XP 中只要变更需求与原需求所需时间资源相等即可变更，而 Scrum 在迭代中需求被冻结
    3.  迭代中，需求是否严格**按照优先级**来实现。XP 中务必遵守优先级别，Scrum 中则比较灵活，原因是可能有需求依赖问题
    4.  **过程工程化**。Scrum 开发过程并未工程化，要求开发者自觉保证，但 XP 则对开发流程定义严格，例如 TDD，结对编程，重构等

#### [](#4143-kanban方法)4.1.4.3. Kanban 方法

1.  精益生产（丰田制造法）的具体实现
2.  可视化工作流、限定 WIP、管理周期时间
3.  马丁提出了微服务架构

#### [](#4144-考试题)4.1.4.4. 考试题

1.  【2015B】XP 规定开发⼈员每周⼯作时间不超过___⼩时，连续加班不可以超过两周，以免降低⽣产率？(B)
    1.  30
    2.  40
    3.  50
    4.  60
2.  【2020-mid】下列不属于看板方法典型实践的是?(BD)
    ...
    3.  限定 WIP
    4.  重构
3.  【2015B】【2016】请结合 SCRUM 这种敏捷⽅法论述敏捷⽅法应该具备的特征？同时解释为何常见的若⼲种描述敏捷⽅法对⽴⾯的⽅法的特征（例如，严格、重型、计划驱动等等）并不合适？10’
    1.  特征
        1.  ⼩周期迭代
        2.  快速响应变更
        3.  价值交付
...
4.  【2015A】敏捷方法的特征有哪些？哪些关于敏捷特征的说法施加于敏捷方法之上是不合适的？为什么？10’
    ...
    2.  关于敏捷方法的一些特征表述可能带着一定的误导，例如:
        1.  **轻量级方法**: 这是对以 XP 为代表的一类方法的误导，事实上，这类方法对工程规范有着极为严格的要求;
        2.  拥抱变更、变更驱动：仅仅是口号，对待变更，所有软件工程方法都是限制和管理的态度。
        3.  TDD 可以提供更高的开发质量: 并没有足够的证据支持。
...
6.  【2016】Devops 三个步骤
7.  【2018】Devops 的特点，为什么流行？
8.  【2018】什么是云原生？相关的重要的概念
9.  【2018】精益屋的两大支柱？
10.  【2018】JIT 及时生产，价值流和价值拉动的关系

#### [](#4145-概念解释)4.1.4.5. 概念解释
...
[](#51-psp是什么)5.1. PSP 是什么？
---------------------------

1.  PSP 是包括了**数据记录表格、过程操作指南和规程**在内的结构化框架。
2.  PSP 着重于**软件开发人员的个人能力提升**，体现在估算能力、计划能力、计划执行以及质量管理等方面
...
[](#52-psp基本原理为什么要有psp)5.2. PSP 基本原理（为什么要有 PSP）
-----------------------------------------------
...
2.  对比度量方式 LOC 和 FP
    1.  LOC
        1.  LOC 优点：LOC 是软件开发项目的生成品，容易进行计算
        2.  LOC 缺点
            1.  LOC 测量依赖于程序设计语言，不同语言产生结果存在偏差
    ...
    2.  FP
        1.  FP 优点
            ...
            2.  面向过程和非过程语言均适合
            3.  基于项目开发初期就可能得到的数据
        2.  FP 缺点：计算基于主观而非客观数据
    3.  随着软件工程产业化分工加剧专门从事软件下游基础业务的商业组织增多，使得基于 LOC 的度量方式逐渐失去意义，而基于 FP 的度量方式显得更加符合要求。
3.  【2014】解释过程度量项定义时应当注意的方面，并且据此评价 PSP 基本度量元的合理之处？6’
4.  【2014】如何对某个软件产品组件进行产品质量评价? 可以选择哪些度量元，这些度量元如何辅助判断产品组件的质量? 8’

### [](#546-probe方法)5.4.6. PROBE 方法

1.  估算的目的是给各类计划提供决策依据

#### [](#5461-估算原理)5.4.6.1. 估算原理

1.  设置合理的代理作为**精确度量**和**早期规划**需要的度量之间的桥梁：相对大小矩阵
2.  相对大小而非绝对大小

#### [](#5462-probe方法例子)5.4.6.2. PROBE 方法例子
...
3.  考试题：【2020-mid】请简要描述按照通用计划框架，为了开发合理的项目计划，应该要做哪些估算？PROBE 方法充当什么角色。
    1.  估算框架如上图
    2.  虚线框即为 PROBE，用来完成规模和资源的评估

#### [](#5465-probe估算过程)5.4.6.5. PROBE 估算过程
...
#### [](#5466-注意点1整理历史数据)5.4.6.6. 注意点 1：整理历史数据
...
1.  **简单方法**
    ...
    3.  缺点：不稳定
2.  **正态分布法**
    1.  内容：均值作为 M，计算标准差σ，则 S=M-σ，VS=M-2σ，L=M+σ，VL=M+2σ
    2.  优点：相对稳定，在历史数据基本符合正态分布的情况下，可以给出非常好的相对大小矩阵
3.  **对数正态分布法**:
    1.  内容：
        1.  以 e 为底计算所有数据的自然对数
        2.  取对数之后的值的均值作为 M，计算相应标准差σ;S=M-σ，VS=M-2σ，L=M+σ，VL=M+2σ
        3.  取反对数
...
4.  **线性回归方法**
 ...
 Plan Size=β0 size​+β1 size​(E)Plan Time=β0 time​+β1 time​(E)Range=t(p,df)δ1+n1​+i=1∑n​(xi​−xavg​)2(xk​−xavg​)2​​Variance=δ2=n−21​i=1∑n​(yi​−β0​−β1​xi​)2​
...
#### [](#5467-注意点2处理有限的历史数据)5.4.6.7. 注意点 2：处理有限的历史数据
...
#### [](#5468-注意点3处理极端数据)5.4.6.8. 注意点 3：处理极端数据

1.  极端数据可能造成相关性假象。

#### [](#5469-考试题)5.4.6.9. 考试题

1.  【2013】【2015A】【2018】谈谈你对项目估算的认识，并简要解释应用 PROBE 方法估算的优缺点
2.  【2018】PROBE 估算的基本流程
3.  【2020-mid】请描述一下 PROBE 方法的基本原理（4’）：2 点
4.  【2020-mid】请描述一下 PROBE 方法的过程 (4’)：流程图
5.  【2020-mid】使用 PROBE 方法估算时间的时候，为什么不使用历史数据中的生产效率数据？(2’)在估算资源需求 (例如，人时) 的时候，生产效率一般在分母上，考虑到个体软件工程师生产效率波动，容易导致估算偏差范围变大。
6.  【2020-mid】请描述 PROBE ABCD 方法在估算规模的时候，对历史数据的质量有什么要求? 10 分)：如上估算规模图示
...
[](#55-psp的质量管理)5.5. PSP 的质量管理
------------------------------

### [](#551-psp质量观与质量策略)5.5.1. PSP 质量观与质量策略

1.  软件项目的**日程、成本以及质量**三大目标统一于质量目标
2.  什么是软件质量？
    1.  与软件产品满足规定的和隐含的需求能力有关的特征或者特征的全体
    2.  PSP 中定义质量为满足用户需求的程度，需要明确用户需求的**范围、优先级、度量方式**
3.  软件质量分为内外两部分的特性
...
#### [](#5511-面向用户的质量观)5.5.1.1. 面向用户的质量观
...
#### [](#5513-质量路径-quality-journey)5.5.1.3. 质量路径 Quality Journey
...
### [](#552-发现缺陷的几个示例流程)5.5.2. 发现缺陷的几个示例流程

#### [](#5521-测试消除缺陷的典型流程)5.5.2.1. 测试消除缺陷的典型流程
...
#### [](#5522-评审发现缺陷的典型流程)5.5.2.2. 评审发现缺陷的典型流程
...
### [](#553-评审与测试)5.5.3. 评审与测试

#### [](#5531-评审检查表)5.5.3.1. 评审检查表

1.  评审检查表的建立和维护：示例见课本
2.  评审检查表的使用

#### [](#5532-评审形式)5.5.3.2. 评审形式
...
#### [](#5535-评审中缺陷预防过程中的缺陷数据选择)5.5.3.5. 评审中缺陷预防过程中的缺陷数据选择
...
### [](#554-psp质量控制的衍生指标)5.5.4. PSP 质量控制的衍生指标

#### [](#5541-yield指标)5.5.4.1. Yield 指标

##### [](#55411-基本定义)5.5.4.1.1. 基本定义
...
3.  IBM：最后的测试如果发现了一个错误，那么其中一定还有一个错误没有被发现（所以最后的 Yield 的值为 50），修改后如下（没有发现的也按照原本的比例来分）
...
4.  Yield 的计算是一种事后的质量控制手段，而且除非发现了所有的缺陷，否则很难非常精确地进行计算。

##### [](#55412-基于yield指标构建缺陷预测模型并列举该模型的可能改进方案2013)5.5.4.1.2. 基于 Yield 指标构建缺陷预测模型，并列举该模型的可能改进方案【2013】

1.  总体思想：利用回归技术预测软件开发过程中各阶段的 Inject Rate(缺陷注入率) 和 Yield(缺陷消除率)
2.  Yield 指标只能用来估算，不可以用来度量。结合 Yield 指标和上图，只需要知道如下指标就可以基于 Yield 指标构建一个基本的缺陷预测模型：
    1.  注入阶段注入多少缺陷
...
#### [](#5543-pqi-process-quality-index-过程质量指标)5.5.4.3. PQI Process Quality Index 过程质量指标

1.  为 5 个数据的乘积 (以基准值作为 1，最后结果越接近 1，质量越高)
    1.  设计质量：设计时间应该大于编码时间，min(编码时间设计时间​,1)
    2.  设计评审质量：设计评审的时间应该大于设计时间的 50%，min(2∗设计时间设计评审时间​,1)
    3.  代码评审质量：代码评审时间应该大于编码时间的 50%，min(2∗编码时间代码评审时间​,1)
    4.  代码质量：代码的编译缺陷密度应当小于 10 个 / 千行，min(编译缺陷密度 +1020​,1)
    5.  程序质量：代码的单元测试缺陷密度应当小于 5 个 / 千行，min(单元测试缺陷密度 +510​,1)
2.  用途
    1.  判断模块开发质量
    2.  规划质量活动计划
    3.  过程改进
3.  【2013】【2018】解释 PQI 指标，如何计算，如何使用

#### [](#5544-review-rate)5.5.4.4. Review Rate

1.  评审的速度是一个用以指导软件工程师开展有效评审的指标
2.  代码评审速度小于 200 LOC(代码行)/h
3.  文档评审速度小于 4 page(文档采用页)/h

#### [](#5545-drl-defect-removal-leverage-缺陷消除效率比)5.5.4.5. DRL Defect-Removal-Leverage 缺陷消除效率比

1.  缺陷消除效率比：不同缺陷消除手段消除缺陷的效率
2.  计算方法：以**某个测试阶段 (一般为单元测试) 每小时发现的缺陷数为基础，其他阶段每小时发现缺陷数与该测试阶段每小时发现的缺陷的比值**就是 DRL
...
#### [](#5546-考试题)5.5.4.6. 考试题

1.  【2015B】请解释 A/FR，PQI 的计算⽅式，并且解释这两个指标有什么⽤途？10’
2.  【2015A】请结合 A/FR、PQI、Review Rate、DRL、Yield 尽可能具体描述⼀个软件项⽬应该如何从多⽅⾯来确保开发的⾼质量？10’
    1.  这些指标既是开发过程中质量管理的⼀些参考指标，同时也体现在计划安排中应该注意的质量元素。具体如下：
        1.  在项⽬计划过程中应该安排确保⾼质量开发结果的活动，例如，按照 A/FR、PQI 等指标的要求，安排对各类产物（⽂档和代码）的个⼈评审和⼩组评审；
        2.  这些评审活动应该满⾜⼀定的要求，特别体现在时间⽅⾯。例如，评审时间应该多于测试时间的两倍以上（A/FR）；评审时间应该是相应开放时间的 50% 以上（PQI）；评审速度要求（Review Rate）等
        3.  充分借鉴质量指标所体现的开发质量状况，尽早制订相应的质量补救措施。例如，PQI 所体现的缺陷密度、所有上述指标的参考值等等。⼀旦超标，往往意味着质量⽅⾯有偏差，应当及时补救。
        4.  利⽤ yield 等指标，构建质量预测模型，更加积极（Proactive）地判定和控制开发质量；
...
1.  【2013】【2015A】如果对质量的追求是无止境的，在不考虑资源和成本的前提下，有哪些可能有效的策略？
    ...
    2.  重视小组评审，同样定义评审过程，并且使得评审过程的 performance 稳定化
    3.  重视个人评审，提升评审者技能;
    4.  重视设计
    5.  开展设计验证
    6.  质量策略：参考上面

[](#56-psp的设计)5.6. PSP 的设计
--------------------------

1.  PSP 设计过程的关注点并不是具体的设计方法，而是设计的步骤定义以及设计的表现形式

### [](#561-设计与质量的关系)5.6.1. 设计与质量的关系
...
### [](#563-设计的过程)5.6.3. 设计的过程

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/21.png)

### [](#564-设计内容)5.6.4. 设计内容

<table><thead><tr><th></th><th>动态信息</th><th>静态信息</th></tr></thead><tbody><tr><td>外部信息</td><td>交互信息 (服务、消息等)</td><td>功能 (继承、类结构等)</td></tr><tr><td>内部信息</td><td>行为信息 (状态机)</td><td>结构信息 (属性、业务逻辑等)</td></tr></tbody></table>

### [](#565-设计模板)5.6.5. 设计模板

<table><thead><tr><th></th><th>动态信息</th><th>静态信息</th></tr></thead><tbody><tr><td>外部信息</td><td>OST/FST</td><td>FST</td></tr><tr><td>内部信息</td><td>SST</td><td>LST</td></tr></tbody></table>

#### [](#5651-操作规格模板-operational-specification-template)5.6.5.1. 操作规格模板 Operational Specification Template

1.  **描述系统与外界的交互**，用于场景描述：也就是”用户 “与” 待设计系统的正常情况和异常情况下的交互。
2.  **定义测试场景和测试用例**，用来与用户讨论需求的基础，特别是操作相关的需求描述
3.  与 UML 比较：用例图、时序图

#### [](#5652-功能规格模板functional-specification-template-简称fst)5.6.5.2. 功能规格模板（Functional Specification Template， 简称 FST）
...
#### [](#5653-状态规格模板state-specification-template简称sst)5.6.5.3. 状态规格模板（State Specification Template，简称 SST）
...
#### [](#5654-逻辑规格模板logical-specification-template简称lst)5.6.5.4. 逻辑规格模板（Logical Specification Template，简称 LST）
...
#### [](#5656-考试题)5.6.5.6. 考试题

1.  【2014】请解释设计的层次的概念和意义，并解释如何将 PSP4 个设计模版应用在不同的设计层次之中? 8’

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/lec5/9.png)

### [](#566-psp设计验证方法)5.6.6. PSP 设计验证方法

#### [](#5661-状态机验证)5.6.6.1. 状态机验证
...
3.  具体验证方法参见 PPT
    1.  使用状态图，检查死循环和陷阱状态
    2.  使用真值表来进行分析
4.  【2015B】下述内容在状态机验证中不⽤以验证状态机本⾝是否正确的是 ©
    1.  没有隐藏的陷阱和死循环
    2.  状态转换是否完整
    3.  状态描述是否完整
    4.  状态转换是否正交

#### [](#5662-符号化验证)5.6.6.2. 符号化验证
...
### [](#612-为什么说需求是一切工程活动的基础)6.1.2. 为什么说 “需求是一切工程活动的基础”
...
### [](#616-需求文档制作)6.1.6. 需求文档制作

1.  需求开发工作完成的一个基本标志是形成了一份完整的、规范的、经过评审的需求规格说明书。
2.  需求规格说明书的编制是为了使用户和软件开发者双方对该软件的初始规定有一个共同的理解，使之成为整个开发工作的基础。

#### [](#6161-优秀需求规格文档特征)6.1.6.1. 优秀需求规格文档特征

<table><thead><tr><th>特征</th><th>描述</th></tr></thead><tbody><tr><td>内聚特征</td><td>需求规格描述应当尽可能内聚，即仅仅用以说明一件事情</td></tr><tr><td>完整特征</td><td>需求规格描述应当完整，不能遗漏信息</td></tr><tr><td>一致特征</td><td>需求规格描述的各个条目和章节不能互相矛盾，需求规格描述与所有外部的参考资料之间也应当消除矛盾之处</td></tr><tr><td>原子特征</td><td>需求规格描述的过程中，应当尽可能避免连接词的使用。如果需要描述多项内容，可以分别用简单语句加以描述</td></tr><tr><td>可跟踪特征</td><td>客户需求、产品需求以及产品组件需求必须可以双向跟踪，即客户需求的任何内容，都应当在产品需求和产品组件需求中得到体现。反之，产品组件需求的每一项描述也要可以跟踪到客户需求中的内容</td></tr><tr><td>非过期特征</td><td>需求描述的内容必须体现相关干系人对于项目的最新认识。即不能包含已经废弃的需求定义</td></tr><tr><td>可行性特征</td><td>需求规格描述的各项内容应该在项目所拥有的资源范围内可以实现</td></tr><tr><td>强制特征</td><td>需求规格描述的内容应当体现强制性，即需求规格描述的内容的任何一项缺失，都会导致最终产品不能满足客户期望。因此，可选的需求内容要么不要出现，要么以明确的方式标注</td></tr><tr><td>可验证特征</td><td>需求规格描述应当便于在后期开发过程中进行验证。即实现该需求与否，应该有明确的判断标准</td></tr></tbody></table>

#### [](#6162-srs示例)6.1.6.2. SRS 示例
...
### [](#626-设计的文档化)6.2.6. 设计的文档化

[](#63-团队工程开发实现策略)6.3. 团队工程开发：实现策略
----------------------------------

### [](#631-评审的考虑)6.3.1. 评审的考虑
...
[](#65-团队工程开发验证与确认-vv)6.5. 团队工程开发：验证与确认 V&V
-------------------------------------------

### [](#651-什么是vv)6.5.1. 什么是 V&V?

1.  验证 (Verification) 活动也是检验获得的产品和产品组件能不能满足各自事先定义好的需求规格；
2.  确认 (Validation) 活动是为了确保产品可以满足客户的需求以及实际操作场景的要求。
3.  验证 (Verification) 和确认 (Validation) 都是为了提升最终产品的质量⽽采取的措施。

### [](#652-vv的区别与联系)6.5.2. V&V 的区别与联系
...
1.  【2015B】请解释在质量保障活动中的 V&V 分别是什么含义？两者之间的关系是什么？5 分
2.  【2014】请举例说明验证和确认的区别和联系? 4 分

[](#66-团队项目规划工作分解结构与范围管理)6.6. 团队项目规划：工作分解结构与范围管理
------------------------------------------------

### [](#661-工作分解结构wbswork-breakdown-structure)6.6.1. 工作分解结构（WBS，Work Breakdown Structure）
...
#### [](#6612-好的wbs的检查标准)6.6.1.2. 好的 WBS 的检查标准
...
[](#67-团队项目规划开发策略与计划)6.7. 团队项目规划：开发策略与计划
----------------------------------------
...
[](#68-团队项目规划生命周期模型选择)6.8. 团队项目规划：生命周期模型选择
------------------------------------------
...
[](#69-团队项目规划计划)6.9. 团队项目规划：计划
------------------------------

### [](#691-日程计划原理和方法)6.9.1. 日程计划原理和方法

#### [](#6911-任务计划和日程计划)6.9.1.1. 任务计划和日程计划
...
#### [](#6912-典型计划流程回顾)6.9.1.2. 典型计划流程回顾

1.  估算规模
2.  估算资源
3.  规划日程

### [](#692-质量计划原理和方法)6.9.2. 质量计划原理和方法
...
4.  【2014】为了确保最终软件产品的质量，在项目计划阶段应该注意哪些问题？4 分

[](#610-团队项目规划tsp项目启动)6.10. 团队项目规划：TSP 项目启动
-------------------------------------------

### [](#6101-tsp的九次会议)6.10.1. TSP 的九次会议
...
1.  【2020-mid】在 TSP 的团队组建过程中，确定软件开发策略的是第几次会议?©
    1.  第一次
    2.  第二次
    3.  第三次
    4.  第四次

[](#611-团队项目跟踪与分析)6.11. 团队项目跟踪与分析
---------------------------------

### [](#6111-项目跟踪意义)6.11.1. 项目跟踪意义
...
### [](#6112-项目的挣值管理方法evmearned-value-managerment)6.11.2. 项目的挣值管理方法（EVM，Earned Value Managerment)

#### [](#61121-什么是evm)6.11.2.1. 什么是 EVM？
...
#### [](#61124-挣值管理的度量)6.11.2.4. 挣值管理的度量
...
#### [](#61125-挣值管理的应用)6.11.2.5. 挣值管理的应用
...
#### [](#61128-考试题)6.11.2.8. 考试题

1.  【2020-mid】下列关于挣值管理方法的描述中错误的是?©
    1.  这是一种可以用来跟踪项目预算消耗的方法
    2.  这种方法高度依赖估算准确性
    3.  这种方法可以支持质量管理
    4.  这种方法可以用来跟踪项目进度

### [](#6113-里程碑评审)6.11.3. 里程碑评审
...
### [](#6123-tsp项目总结方式)6.12.3. TSP 项目总结方式
...
### [](#6124-通用项目总结流程)6.12.4. 通用项目总结流程

1.  准备阶段
2.  总结阶段
3.  报告阶段

### [](#6125-项目总结的意义)6.12.5. 项目总结的意义

提供一个系统化的方式来总结经验教训、防止犯同样的错误、评估项目团队绩效、积累过程数据等，给项目团队成员持续学习和改进的机会。

[](#613-项目管理支持活动)6.13. 项目管理支持活动
-------------------------------

1.  项目管理支持活动包含：配置管理、度量和分析、决策分析和根因分析。

### [](#6131-配置管理)6.13.1. 配置管理

#### [](#61311-配置管理的目的)6.13.1.1. 配置管理的目的

建立与维护工作产品的完整性

#### [](#61312-配置管理的概念)6.13.1.2. 配置管理的概念
...
#### [](#61313-配置管理的流程)6.13.1.3. 配置管理的流程
...
### [](#6132-度量和分析)6.13.2. 度量和分析

#### [](#61321-度量和分析简介)6.13.2.1. 度量和分析简介
...
#### [](#61322-度量和分析活动)6.13.2.2. 度量和分析活动
...
#### [](#61323-gqm方法的原理和应用)6.13.2.3. GQM 方法的原理和应用
...
#### [](#61324-考试题目)6.13.2.4. 考试题目

1.  【2013】请结合 GQM 思想解释 PSP 过程的基本度量元有哪几个？
2.  【2015B】请描述⼀下度量和分析活动在⼀个软件项⽬当中的作⽤，以及应该如何正确开展？10’
    1.  可以描述度量和分析活动
    2.  也可以描述 GQM

### [](#6133-决策分析)6.13.3. 决策分析
...
#### [](#61414-自主团队的必要性)6.14.1.4. 自主团队的必要性
...
#### [](#61415-自主团队的形成)6.14.1.5. 自主团队的形成
...
#### [](#61416-自主团队的外部环境)6.14.1.6. 自主团队的外部环境
...
#### [](#61421-交易型领导方式)6.14.2.1. 交易型领导方式

1.  承诺奖励激励
2.  人们通常能找到新的方式来获得奖励，同时少做工作。
3.  威逼和利诱属于交易型领导方式。

#### [](#61422-转变型领导方式)6.14.2.2. 转变型领导方式

1.  用成就激励
2.  鼓励承诺属于转变型领导方式。
3.  由于交易型领导方式很少能产生成功并且有创造性的团队，因此**转变型领导方式**是首选。

### [](#6143-马斯洛的需求层次理论)6.14.3. 马斯洛的需求层次理论
...
### [](#6144-承诺文化的建立与团队激励)6.14.4. 承诺文化的建立与团队激励
...
#### [](#61441-海兹伯格的激励理论)6.14.4.1. 海兹伯格的激励理论

1.  激励因素（内在因素）：成就感、责任感、晋升、被赏识、认可。
2.  保健因素（外在因素）：工作环境、薪金、工作关系、安全等。

#### [](#61442-麦克勒格的-x-y-理论)6.14.4.2. 麦克勒格的 X、Y－理论
...
#### [](#61443-期望理论-expectancy-theory)6.14.4.3. 期望理论 Expectancy Theory
...
#### [](#61444-提高成功把握的两种方法)6.14.4.4. 提高成功把握的两种方法
...
2.  【2014】自主团队有哪些特点？为什么说这样的团队可以满足软件开发对团队的要求
    ...
    2.  软件开发⼀种智⼒活动，开发者是智⼒劳动者，⽽对于智⼒劳动者⽽⾔，管理的第⼀准则就是智⼒劳动者不能被管理，只能实现⾃我管理：
        ...
        3.  全⾝⼼地参与
        4.  努⼒做出卓越的⼯作
3.  【2020-mid】请结合软件开发的特点介绍软件项目管理中自主型团队的必要性以及自主团队应该具备的特征? 5 分
    1.  软件开发是一项既复杂又富有创造性的知识工作 (1’)
    2.  软件开发是一种智力劳动 (1’)
        1.  处理和讨论 极其抽象的概念
        2.  把不同的部分 (不可见) 整合成一个可以工作的系统
    3.  自主团队具备如下的特点: (每两点 1 分)
        1.  自行定义项目的目标
        2.  自行决定团队组成形式以及成员的角色
        3.  自行决定项目的开发策略
        4.  自行定义项目的开发过程
...
[](#615-tsp的典型角色)6.15. TSP 的典型角色
--------------------------------

### [](#6151-项目组长)6.15.1. 项目组长
...
### [](#6153-开发经理)6.15.3. 开发经理

1.  开发优秀的软件产品
2.  充分利用团队成员的技能

#### [](#61531-典型技能)6.15.3.1. 典型技能
...
### [](#6155-过程经理)6.15.5. 过程经理

1.  所有团队成员准确的记录、报告和跟踪过程数据。
2.  所有的团队会议都有相应会议记录。

#### [](#61551-典型技能)6.15.5.1. 典型技能

1.  你对过程定义、过程度量非常感兴趣
2.  你对过程改进非常感兴趣

#### [](#61552-工作内容)6.15.5.2. 工作内容
...
### [](#6157-开发人员)6.15.7. 开发人员

### [](#6158-考试题题目)6.15.8. 考试题题目

1.  【2016】TSP 项目经理、过程经理、计划经理的工作内容、项目总结角度 9’
...
[](#75-定量模型构建的关键实践)7.5. 定量模型构建的关键实践
-----------------------------------
...
<table><thead><tr><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/38.png"></th><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/39.png"></th></tr></thead><tbody></tbody></table>

#### [](#7712-常用非统计技术帕累托图)7.7.1.2. 常用非统计技术：帕累托图
...
#### [](#7713-常用非统计技术因果图)7.7.1.3. 常用非统计技术：因果图
...
#### [](#7714-常用非统计技术散布点图)7.7.1.4. 常用非统计技术：散布（点）图
...
#### [](#7721-常用统计技术控制图)7.7.2.1. 常用统计技术：控制图
...
4.  控制图可由正态分布演变而来
5.  正态分布可用两个参数即均值μ和标准差σ来决定。正态分布有一个结论对质量管理很有用，即无论均值μ和标准差σ取何值，产品质量特性值落在μ±3σ之间的概率为 99.73%，落在μ±3σ之外的概率为 100%-99.73%=0.27%，而超过一侧，即大于μ+3σ或小于μ-3σ的概率为 0.27%/2=0.135%≈1‰。

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/44.png)

6.  以下显示了不处于受控状态的 8 种典型情况（异常模式）：

<table><thead><tr><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/45.png"></th><th><img class="" src="https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/46.png"></th></tr></thead><tbody></tbody></table>

7.  两类错误（需要检验）：
    1.  **Ⅰ 类错误：虚发警报错误**，在生产正常的情况下, 纯粹出于偶然而点子出界的概率虽然很小, 但不是绝对不可能发生。故当生产正常而根据点出界判断生产异常就犯了虚发警报错误, 发生这种错误的概率通常记以α
    2.  Ⅱ 类错误：漏发警报错误, 在生产异常的情况下, 产品质量的分布偏离典型分布, 但总有一部分产品的质量特性值在上下控制界之内。如果抽到这样的产品进行检测描点, 根据点未出界判断生产正常就为漏发警报错误, 此概率通常记以β。

![](https://spricoder.oss-cn-shanghai.aliyuncs.com/2021-software-quality-management/img/exam/47.png)

# 8.零散题目

1.  【2015B】为了制定 Schedule plan，下述描述中，哪⼀项是不需要的:(A)
    1.  Task size
    2.  Task Order
    3.  Schedule Hour
    4.  Task hour for each task
2.  【2015B】在上题中，还需要补充下述哪⼀项数据就可以定义 Schedule Plan 了？(A)
    1.  Task List
    2.  Plan Value
    3.  Earned Value
    4.  Nothing
3.  【2020-mid】下列术语描述的技术或者方法是同类型的是?(CD)
    1.  CMMI SPICE PDCA：SPICE 是软件过程管理
    2.  IDEAL XP SCRUM：IDEAL 是软件过程改进，XP 和 SCRUM 是软件过程
    3.  Cleanroom Gate TSP：软件过程
    4.  Waterfall SCRUM XP：软件实践
4.  【2015A】请列出 Capture-recapture ⽅法进⾏缺陷预测的假设条件和相应的模型定义
    1.  常见 CRC 模型定义了两个参数，即评审者发现缺陷能⼒ t 和缺陷的难度 h，t 是否⼀致以及 h 是否⼀致都会影响模型。⼀边来说，定义如下 4 个基本模型：
    2.  假设 h 和 t 都⼀样的 M0 模型
    3.  假设 h 不等⽽ t 都⼀样的 Mh 模型
    4.  假设 t 不等⽽ h 都⼀样的 Mt 模型
    5.  假设 t 和 h 都不等的 Mth 模型
5.  估算与计划的差异
